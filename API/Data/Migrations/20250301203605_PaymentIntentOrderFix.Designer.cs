...
namespace API.Data.Migrations
{
    ...
    [Migration("20250301203605_PaymentIntentOrderFix")]
    partial class PaymentIntentOrderFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.UserAddess", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("API.Entities.UserAddess", b =>
                {
                    b.HasOne("API.Entities.User", null)
                        .WithOne("Address")
                        .HasForeignKey("API.Entities.UserAddess", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
